...
vid_file=$fishtrack_path'bv2-2018_vid_list.txt'
#vid_dir='/data/postures/birdview2-2019/'
merge_file=$fishtrack_path'bv2-18_clip_list.txt'
...
for f in $vid_list; do
    ...
    ffmpeg -i $f -vf "select='between(t,1,1.25) + between(t,2,2.25)', setpts=N/FRAME_RATE/TB" -an $out_path -y
